...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         ...
         <textarea name="msg" class="box" required placeholder="Nhập Thông Báo Của Bạn" maxlength="500" cols="30" rows="10"></textarea>
