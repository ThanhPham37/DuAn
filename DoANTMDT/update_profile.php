...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="Nhập Mật Khẩu Cũ Của Bạn" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" placeholder="Nhập Mật Khẩu Mới Của Bạn" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
